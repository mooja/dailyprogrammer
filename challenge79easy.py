...
# Daily Programmer Challenge 79 Easy
#
...
# steps is a positive integer greater than or equal to 2, a and b are
...
def step_count(a, b, nsteps):
    stride = (b - a) / (nsteps - 1)
    output = [a]
    while output[-1] != b:
        output.append(output[-1] + stride)
    return output
